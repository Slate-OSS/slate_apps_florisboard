...
data class ImeFormFactor(
    ...
    companion object {
        ...
        fun of(boundsDp: DpRect): ImeFormFactor {
            ...
            val typeGuess = when {
                sizeClass.isWidthAtLeastBreakpoint(WindowSizeClass.Companion.WIDTH_DP_EXTRA_LARGE_LOWER_BOUND) -> {
                    Type.DESKTOP
                }
                sizeClass.isWidthAtLeastBreakpoint(WindowSizeClass.Companion.WIDTH_DP_LARGE_LOWER_BOUND) -> {
                    Type.LARGE_TABLET
                }
                sizeClass.isAtLeastBreakpoint(WindowSizeClass.Companion.WIDTH_DP_MEDIUM_LOWER_BOUND, WindowSizeClass.Companion.HEIGHT_DP_EXPANDED_LOWER_BOUND) -> {
                    Type.TABLET_PORTRAIT
                }
                sizeClass.isAtLeastBreakpoint(WindowSizeClass.Companion.WIDTH_DP_EXPANDED_LOWER_BOUND, WindowSizeClass.Companion.HEIGHT_DP_MEDIUM_LOWER_BOUND) -> {
                    Type.TABLET_LANDSCAPE
                }
                sizeClass.isHeightAtLeastBreakpoint(WindowSizeClass.Companion.HEIGHT_DP_MEDIUM_LOWER_BOUND) -> {
                    Type.PHONE_PORTRAIT
                }
